...
import { fetchStoreData,RatingProductUserById } from "../../../features/reducer/thunks";
...
const FilterJobsBox = () => {
  ...
  console.log(RatingProductRes,'RatingProductRes');

  useEffect(() => {
    dispatch(RatingProductUserById());
  }, []);
  ...
  const content = RatingProductRes?.companies && RatingProductRes?.companies?.slice(0, 6).map((item) => (
    <div className="job-block" key={item.id}>
      <div className="inner-box">
        <div className="content">
          <span className="company-logo">
            <Image width={50} height={49} src={item.imageUrl} alt="item brand" />
          </span>
          <h4>
